...
from .models import Faculty, FacultyBreadcrumb, Division, DivisionBreadcrumb, Department, Staff
...
def faculty_detail(request, slug):
    ...
    departments = Department.objects.filter(faculty=faculty, is_active=True).order_by('order')
